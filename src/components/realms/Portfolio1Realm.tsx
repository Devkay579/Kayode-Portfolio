        ...
        >
          ...
          <div className="p-6 md:p-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <h1 className="text-4xl md:text-5xl font-light text-[#2C5F4A]">Portfolio 2025</h1>
            ...
            <p className="text-lg text-[#2D2D2D] leading-relaxed mb-8">
              A modern, minimalist portfolio designed to showcase creative work with a focus on typography and 
              smooth interactions. The design balances professionalism with personality, using a warm paper 
              aesthetic and subtle animations to create an inviting user experience.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://portfolio2025.vercel.app"
                target="_blank"
              ...
              <a
                href="https://github.com/yourusername/portfolio-2025"
                target="_blank"
                rel="noopener noreferrer"
