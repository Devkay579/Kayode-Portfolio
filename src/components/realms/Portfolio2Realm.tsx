      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <div className="relative h-48 md:h-64 bg-gradient-to-r from-[#2C5F4A]/20 to-[#2C5F4A]/5">
            <img
              src="/projects/ecommerce-cover.jpg"
          ...
          <div className="p-6 md:p-10">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <h1 className="text-4xl md:text-5xl font-light text-[#2C5F4A]">E-Commerce Platform</h1>
              <div className="flex flex-wrap gap-3 text-sm">
                <span className="flex items-center gap-1 bg-[#F5F2E8] px-3 py-1 rounded-full text-[#2D2D2D]">
                  <Calendar size={14} /> 2024
                </span>
                <span className="flex items-center gap-1 bg-[#F5F2E8] px-3 py-1 rounded-full text-[#2D2D2D]">
                  <User size={14} /> Full Stack
                </span>
              </div>
            </div>

            <p className="text-lg text-[#2D2D2D] leading-relaxed mb-8">
              A fully functional e-commerce platform with user authentication, product management, shopping cart, 
              and Stripe payments. Built as a demonstration of full-stack capabilities, including a RESTful API 
